(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/2374f_firebase-admin_ab231c82._.js",
"[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

var __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__ = /*#__PURE__*/ __turbopack_context__.i("[externals]/node:buffer [external] (node:buffer, cjs)");
/*! firebase-admin v13.6.1 */ "use strict";
/*!
 * @license
...
"[project]/web/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const deep_copy_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/app/credential-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const google_auth_library_1 = __turbopack_context__.r("[project]/web/node_modules/google-auth-library/build/src/index.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const util = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const SCOPES = [
 ...
 */ class ServiceAccount {
    ...
    constructor(json){
        ...
        const forge = __turbopack_context__.r("[project]/web/node_modules/node-forge/lib/index.js [middleware-edge] (ecmascript)");
        try {
...
"[project]/web/node_modules/firebase-admin/lib/app/firebase-app.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const credential_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/credential-internal.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const deep_copy_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/app/lifecycle.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const credential_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/credential-internal.js [middleware-edge] (ecmascript)");
const firebase_app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/firebase-app.js [middleware-edge] (ecmascript)");
const fastDeepEqual = __turbopack_context__.r("[project]/web/node_modules/fast-deep-equal/index.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/app/credential-factory.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function getSdkVersion() {
    if (!sdkVersion) {
        const { version } = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/package.json (json)"); // eslint-disable-line @typescript-eslint/no-var-requires
        sdkVersion = version;
    }
    return sdkVersion;
}
...
"[project]/web/node_modules/firebase-admin/lib/utils/api-request.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const https = __turbopack_context__.r("[project]/ [middleware-edge] (unsupported edge import 'https', ecmascript)");
const http2 = __turbopack_context__.r("[project]/ [middleware-edge] (unsupported edge import 'http2', ecmascript)");
const url = __turbopack_context__.r("[project]/web/node_modules/next/dist/compiled/native-url/index.js [middleware-edge] (ecmascript)");
const events_1 = __turbopack_context__.r("[externals]/node:events [external] (node:events, cjs)");
const credential_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/credential-internal.js [middleware-edge] (ecmascript)");
const index_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
 ...
 */ class AsyncRequestCall {
    ...
    handleMultipartResponse(response, respStream, boundary) {
        const busboy = __turbopack_context__.r("[project]/web/node_modules/@fastify/busboy/lib/main.js [middleware-edge] (ecmascript)"); // eslint-disable-line @typescript-eslint/no-var-requires
 ...
 */ class AsyncHttpCall extends AsyncRequestCall {
    ...
    uncompressResponse(res) {
        ...
        if (res.headers['content-encoding'] && encodings.indexOf(res.headers['content-encoding']) !== -1) {
            ...
            const zlib = __turbopack_context__.r("[project]/ [middleware-edge] (unsupported edge import 'zlib', ecmascript)"); // eslint-disable-line @typescript-eslint/no-var-requires
...
"[project]/web/node_modules/firebase-admin/lib/auth/user-import-builder.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const deep_copy_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)");
const utils = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/auth/action-code-settings-builder.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/auth/auth-config.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/auth/tenant.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const deep_copy_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const auth_config_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/auth-config.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/auth/identifier.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/auth/project-config.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";

/*! firebase-admin v13.6.1 */ Object.defineProperty(exports, "__esModule", {
    value: true
});
...
"[project]/web/node_modules/firebase-admin/lib/auth/auth-api-request.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const deep_copy_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const api_request_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/api-request.js [middleware-edge] (ecmascript)");
const utils = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const user_import_builder_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/user-import-builder.js [middleware-edge] (ecmascript)");
const action_code_settings_builder_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/action-code-settings-builder.js [middleware-edge] (ecmascript)");
const tenant_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/tenant.js [middleware-edge] (ecmascript)");
const identifier_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/identifier.js [middleware-edge] (ecmascript)");
const auth_config_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/auth-config.js [middleware-edge] (ecmascript)");
const project_config_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/project-config.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/utils/crypto-signer.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class ServiceAccountSigner {
     ...
     * @inheritDoc
     */ sign(buffer) {
        const crypto = __turbopack_context__.r("[project]/ [middleware-edge] (unsupported edge import 'crypto', ecmascript)"); // eslint-disable-line @typescript-eslint/no-var-requires
...
"[project]/web/node_modules/firebase-admin/lib/auth/token-generator.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const crypto_signer_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/crypto-signer.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const utils_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/utils/jwt.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const jwt = __turbopack_context__.r("[project]/web/node_modules/jsonwebtoken/index.js [middleware-edge] (ecmascript)");
const jwks = __turbopack_context__.r("[project]/web/node_modules/jwks-rsa/src/index.js [middleware-edge] (ecmascript)");
const api_request_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/api-request.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/auth/token-verifier.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const util = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const jwt_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/jwt.js [middleware-edge] (ecmascript)");
// Audience to use for Firebase Auth Custom tokens
const FIREBASE_AUDIENCE = 'https://identitytoolkit.googleapis.com/google.identity.identitytoolkit.v1.IdentityToolkit';
...
"[project]/web/node_modules/firebase-admin/lib/auth/user-record.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const deep_copy_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)");
const validator_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const utils = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/auth/base-auth.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const deep_copy_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const auth_api_request_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/auth-api-request.js [middleware-edge] (ecmascript)");
const token_generator_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/token-generator.js [middleware-edge] (ecmascript)");
const token_verifier_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/token-verifier.js [middleware-edge] (ecmascript)");
const auth_config_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/auth-config.js [middleware-edge] (ecmascript)");
const user_record_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/user-record.js [middleware-edge] (ecmascript)");
const identifier_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/identifier.js [middleware-edge] (ecmascript)");
const crypto_signer_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/crypto-signer.js [middleware-edge] (ecmascript)");
/**
 * @internal
...
"[project]/web/node_modules/firebase-admin/lib/auth/tenant-manager.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const utils = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const base_auth_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/base-auth.js [middleware-edge] (ecmascript)");
const tenant_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/tenant.js [middleware-edge] (ecmascript)");
const auth_api_request_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/auth-api-request.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/auth/project-config-manager.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/auth/auth.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
exports.Auth = void 0;
const auth_api_request_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/auth-api-request.js [middleware-edge] (ecmascript)");
const tenant_manager_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/tenant-manager.js [middleware-edge] (ecmascript)");
const base_auth_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/base-auth.js [middleware-edge] (ecmascript)");
const project_config_manager_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/project-config-manager.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/messaging/messaging-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/messaging/messaging-errors-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/messaging/messaging-api-request-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const api_request_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/api-request.js [middleware-edge] (ecmascript)");
const messaging_errors_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/messaging/messaging-errors-internal.js [middleware-edge] (ecmascript)");
const index_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/messaging/messaging.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const utils = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const messaging_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/messaging/messaging-internal.js [middleware-edge] (ecmascript)");
const messaging_api_request_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/messaging/messaging-api-request-internal.js [middleware-edge] (ecmascript)");
const api_request_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/api-request.js [middleware-edge] (ecmascript)");
// FCM endpoints
...
"[project]/web/node_modules/firebase-admin/lib/storage/storage.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ class Storage {
     ...
     */ constructor(app){
        ...
        let storage;
        try {
            storage = __turbopack_context__.r("[project]/web/node_modules/@google-cloud/storage/build/cjs/src/index.js [middleware-edge] (ecmascript)").Storage;
        } catch (err) {
            throw new error_1.FirebaseError({
...
"[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const utils_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
var lifecycle_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/lifecycle.js [middleware-edge] (ecmascript)");
...
var credential_factory_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/credential-factory.js [middleware-edge] (ecmascript)");
...
var error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/storage/utils.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/storage/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const storage_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/storage/storage.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const utils_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/storage/utils.js [middleware-edge] (ecmascript)");
var storage_2 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/storage/storage.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/machine-learning/machine-learning-utils.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/machine-learning/machine-learning-api-client.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const utils = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const machine_learning_utils_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/machine-learning/machine-learning-utils.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/machine-learning/machine-learning.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const index_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/storage/index.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const deep_copy_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/deep-copy.js [middleware-edge] (ecmascript)");
const utils = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const machine_learning_api_client_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/machine-learning/machine-learning-api-client.js [middleware-edge] (ecmascript)");
const machine_learning_utils_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/machine-learning/machine-learning-utils.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/installations/installations-request-handler.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/installations/installations.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const installations_request_handler_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/installations/installations-request-handler.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/installations/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 */ const index_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const installations_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/installations/installations.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/instance-id/instance-id.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const installations_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/installations/index.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/project-management/project-management-api-request-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/project-management/app-metadata.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/project-management/android-app.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const project_management_api_request_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/project-management-api-request-internal.js [middleware-edge] (ecmascript)");
const app_metadata_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/app-metadata.js [middleware-edge] (ecmascript)");
/**
 ...
 */ class AndroidApp {
     ...
     */ getConfig() {
        return this.requestHandler.getConfig(this.resourceName).then((responseData)=>{
            ...
            return __TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(base64ConfigFileContents, 'base64').toString('utf8');
        });
    }
}
...
"[project]/web/node_modules/firebase-admin/lib/project-management/ios-app.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/project-management/project-management.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const utils = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const android_app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/android-app.js [middleware-edge] (ecmascript)");
const ios_app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/ios-app.js [middleware-edge] (ecmascript)");
const project_management_api_request_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/project-management-api-request-internal.js [middleware-edge] (ecmascript)");
const app_metadata_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/app-metadata.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/security-rules/security-rules-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/security-rules/security-rules-api-client-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const api_request_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/api-request.js [middleware-edge] (ecmascript)");
const error_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/error.js [middleware-edge] (ecmascript)");
const security_rules_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/security-rules/security-rules-internal.js [middleware-edge] (ecmascript)");
const utils = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/security-rules/security-rules.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const security_rules_api_client_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/security-rules/security-rules-api-client-internal.js [middleware-edge] (ecmascript)");
const security_rules_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/security-rules/security-rules-internal.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/remote-config/remote-config-api-client-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/remote-config/remote-config-api.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/remote-config/condition-evaluator-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const remote_config_api_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/remote-config/remote-config-api.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/remote-config/internal/value-impl.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/remote-config/remote-config.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const utils = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const remote_config_api_client_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/remote-config/remote-config-api-client-internal.js [middleware-edge] (ecmascript)");
const condition_evaluator_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/remote-config/condition-evaluator-internal.js [middleware-edge] (ecmascript)");
const value_impl_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/remote-config/internal/value-impl.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/app-check/app-check-api-client-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/app-check/token-generator.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const utils_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
const crypto_signer_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/crypto-signer.js [middleware-edge] (ecmascript)");
const app_check_api_client_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app-check/app-check-api-client-internal.js [middleware-edge] (ecmascript)");
 ...
 */ class AppCheckTokenGenerator {
     ...
     */ createCustomToken(appId, options) {
        ...
        return this.signer.getAccountId().then((account)=>{
            ...
            const token = `${this.encodeSegment(header)}.${this.encodeSegment(body)}`;
            return this.signer.sign(__TURBOPACK__imported__module__$5b$externals$5d2f$node$3a$buffer__$5b$external$5d$__$28$node$3a$buffer$2c$__cjs$29$__["Buffer"].from(token)).then((signature)=>{
                return `${token}.${this.encodeSegment(signature)}`;
            });
        }).catch((err)=>{
...
"[project]/web/node_modules/firebase-admin/lib/app-check/token-verifier.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
"[project]/web/node_modules/firebase-admin/lib/app-check/app-check.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const validator = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/validator.js [middleware-edge] (ecmascript)");
const app_check_api_client_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app-check/app-check-api-client-internal.js [middleware-edge] (ecmascript)");
const token_generator_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app-check/token-generator.js [middleware-edge] (ecmascript)");
const token_verifier_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app-check/token-verifier.js [middleware-edge] (ecmascript)");
const crypto_signer_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/crypto-signer.js [middleware-edge] (ecmascript)");
/**
...
"[project]/web/node_modules/firebase-admin/lib/auth/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * @packageDocumentation
 */ const index_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const auth_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/auth.js [middleware-edge] (ecmascript)");
/**
...
var auth_2 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/auth.js [middleware-edge] (ecmascript)");
...
var base_auth_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/base-auth.js [middleware-edge] (ecmascript)");
...
var tenant_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/tenant.js [middleware-edge] (ecmascript)");
...
var tenant_manager_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/tenant-manager.js [middleware-edge] (ecmascript)");
...
var project_config_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/project-config.js [middleware-edge] (ecmascript)");
...
var project_config_manager_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/project-config-manager.js [middleware-edge] (ecmascript)");
...
var user_record_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/user-record.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/app-check/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * @packageDocumentation
 */ const app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const app_check_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app-check/app-check.js [middleware-edge] (ecmascript)");
var app_check_2 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app-check/app-check.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/database/database.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const url_1 = __turbopack_context__.r("[project]/web/node_modules/next/dist/compiled/native-url/index.js [middleware-edge] (ecmascript)");
...
class DatabaseService {
    ...
    getDatabase(url) {
        ...
        if (typeof db === 'undefined') {
            // eslint-disable-next-line @typescript-eslint/no-var-requires
            const rtdb = __turbopack_context__.r("[project]/web/node_modules/@firebase/database-compat/dist/index.standalone.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/database/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const standalone_1 = __turbopack_context__.r("[project]/web/node_modules/@firebase/database-compat/dist/index.standalone.js [middleware-edge] (ecmascript)");
const app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const database_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/database/database.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/messaging/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * @packageDocumentation
 */ const app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const messaging_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/messaging/messaging.js [middleware-edge] (ecmascript)");
var messaging_2 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/messaging/messaging.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/firestore/firestore-internal.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
function initFirestore(app, databaseId, firestoreSettings) {
    ...
    try {
        ...
        firestoreDatabase = __turbopack_context__.r("[project]/web/node_modules/@google-cloud/firestore/build/src/index.js [middleware-edge] (ecmascript)").Firestore;
    } catch (err) {
        throw new error_1.FirebaseFirestoreError({
...
"[project]/web/node_modules/firebase-admin/lib/firestore/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const firestore_internal_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/firestore/firestore-internal.js [middleware-edge] (ecmascript)");
const path_1 = __turbopack_context__.r("[project]/web/node_modules/@google-cloud/firestore/build/src/path.js [middleware-edge] (ecmascript)");
var firestore_1 = __turbopack_context__.r("[project]/web/node_modules/@google-cloud/firestore/build/src/index.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/instance-id/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * @packageDocumentation
 */ const index_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const instance_id_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/instance-id/instance-id.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/machine-learning/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * @packageDocumentation
 */ const app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const machine_learning_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/machine-learning/machine-learning.js [middleware-edge] (ecmascript)");
var machine_learning_2 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/machine-learning/machine-learning.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/project-management/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * @packageDocumentation
 */ const app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const project_management_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/project-management.js [middleware-edge] (ecmascript)");
var app_metadata_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/app-metadata.js [middleware-edge] (ecmascript)");
...
var project_management_2 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/project-management.js [middleware-edge] (ecmascript)");
...
var android_app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/android-app.js [middleware-edge] (ecmascript)");
...
var ios_app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/ios-app.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/security-rules/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * @packageDocumentation
 */ const app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const security_rules_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/security-rules/security-rules.js [middleware-edge] (ecmascript)");
var security_rules_2 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/security-rules/security-rules.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/remote-config/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * @packageDocumentation
 */ const app_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/index.js [middleware-edge] (ecmascript)");
const remote_config_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/remote-config/remote-config.js [middleware-edge] (ecmascript)");
var remote_config_api_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/remote-config/remote-config-api.js [middleware-edge] (ecmascript)");
...
var remote_config_2 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/remote-config/remote-config.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/app/firebase-namespace.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const lifecycle_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/lifecycle.js [middleware-edge] (ecmascript)");
const credential_factory_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/credential-factory.js [middleware-edge] (ecmascript)");
const index_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/utils/index.js [middleware-edge] (ecmascript)");
/**
 ...
 */ class FirebaseNamespace {
     ...
     */ get auth() {
        ...
        const auth = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/auth.js [middleware-edge] (ecmascript)").Auth;
     ...
     */ get database() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        return Object.assign(fn, __turbopack_context__.r("[project]/web/node_modules/@firebase/database-compat/dist/index.standalone.js [middleware-edge] (ecmascript)"));
    }
    /**
     ...
     */ get messaging() {
        ...
        const messaging = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/messaging/messaging.js [middleware-edge] (ecmascript)").Messaging;
        return Object.assign(fn, {
            Messaging: messaging
        });
    }
     ...
     */ get storage() {
        ...
        const storage = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/storage/storage.js [middleware-edge] (ecmascript)").Storage;
        return Object.assign(fn, {
            Storage: storage
        });
    }
     ...
     */ get firestore() {
        ...
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        const firestore = __turbopack_context__.r("[project]/web/node_modules/@google-cloud/firestore/build/src/index.js [middleware-edge] (ecmascript)");
     ...
     */ get machineLearning() {
        ...
        const machineLearning = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/machine-learning/machine-learning.js [middleware-edge] (ecmascript)").MachineLearning;
        return Object.assign(fn, {
     ...
     */ get installations() {
        ...
        const installations = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/installations/installations.js [middleware-edge] (ecmascript)").Installations;
        return Object.assign(fn, {
     ...
     */ get instanceId() {
        ...
        const instanceId = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/instance-id/instance-id.js [middleware-edge] (ecmascript)").InstanceId;
        return Object.assign(fn, {
     ...
     */ get projectManagement() {
        ...
        const projectManagement = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/project-management.js [middleware-edge] (ecmascript)").ProjectManagement;
        return Object.assign(fn, {
     ...
     */ get securityRules() {
        ...
        const securityRules = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/security-rules/security-rules.js [middleware-edge] (ecmascript)").SecurityRules;
        return Object.assign(fn, {
     ...
     */ get remoteConfig() {
        ...
        const remoteConfig = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/remote-config/remote-config.js [middleware-edge] (ecmascript)").RemoteConfig;
        return Object.assign(fn, {
     ...
     */ get appCheck() {
        ...
        const appCheck = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app-check/app-check.js [middleware-edge] (ecmascript)").AppCheck;
        return Object.assign(fn, {
            AppCheck: appCheck
        });
    }
...
function extendApp(app) {
    ...
    result.auth = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/auth/index.js [middleware-edge] (ecmascript)").getAuth;
        return fn(app);
    };
    result.appCheck = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app-check/index.js [middleware-edge] (ecmascript)").getAppCheck;
        return fn(app);
    };
    result.database = (url)=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/database/index.js [middleware-edge] (ecmascript)").getDatabaseWithUrl;
        return fn(url, app);
    };
    result.messaging = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/messaging/index.js [middleware-edge] (ecmascript)").getMessaging;
        return fn(app);
    };
    result.storage = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/storage/index.js [middleware-edge] (ecmascript)").getStorage;
        return fn(app);
    };
    result.firestore = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/firestore/index.js [middleware-edge] (ecmascript)").getFirestore;
        return fn(app);
    };
    result.instanceId = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/instance-id/index.js [middleware-edge] (ecmascript)").getInstanceId;
        return fn(app);
    };
    result.installations = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/installations/index.js [middleware-edge] (ecmascript)").getInstallations;
        return fn(app);
    };
    result.machineLearning = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/machine-learning/index.js [middleware-edge] (ecmascript)").getMachineLearning;
        return fn(app);
    };
    result.projectManagement = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/project-management/index.js [middleware-edge] (ecmascript)").getProjectManagement;
        return fn(app);
    };
    result.securityRules = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/security-rules/index.js [middleware-edge] (ecmascript)").getSecurityRules;
        return fn(app);
    };
    result.remoteConfig = ()=>{
        const fn = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/remote-config/index.js [middleware-edge] (ecmascript)").getRemoteConfig;
        return fn(app);
    };
...
"[project]/web/node_modules/firebase-admin/lib/default-namespace.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const firebase_namespace_1 = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/app/firebase-namespace.js [middleware-edge] (ecmascript)");
...
"[project]/web/node_modules/firebase-admin/lib/index.js [middleware-edge] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const firebase = __turbopack_context__.r("[project]/web/node_modules/firebase-admin/lib/default-namespace.js [middleware-edge] (ecmascript)");
...
//# sourceMappingURL=2374f_firebase-admin_ab231c82._.js.map