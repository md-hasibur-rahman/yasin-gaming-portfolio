(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__ac4de322._.js",
...
"[project]/web/src/lib/firebase/admin.ts [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/node_modules/firebase-admin/lib/index.js [middleware-edge] (ecmascript)");
;
const serviceAccount = process.env.FIREBASE_SERVICE_ACCOUNT_KEY ? JSON.parse(process.env.FIREBASE_SERVICE_ACCOUNT_KEY) : null;
if (!__TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["apps"].length) {
    if (serviceAccount) {
        __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["initializeApp"]({
            credential: __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["credential"].cert(serviceAccount),
...
const adminAuth = __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["auth"]();
const adminDb = __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$firebase$2d$admin$2f$lib$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["firestore"]();
;
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$firebase$2f$admin$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/web/src/lib/firebase/admin.ts [middleware-edge] (ecmascript)");
;
;
async function middleware(req) {
    ...
    if (!session) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(url);
    }
    try {
        // 2. Verify the session cookie
        const decodedToken = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$firebase$2f$admin$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["adminAuth"].verifySessionCookie(session, true);
        const userEmail = (decodedToken.email || "").toLowerCase();
        const MAIN_ADMIN = "animeandmanga1810@gmail.com";
        // 3. Admin Check
        let isUserAdmin = userEmail === MAIN_ADMIN;
        if (!isUserAdmin) {
            const adminDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$web$2f$src$2f$lib$2f$firebase$2f$admin$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["adminDb"].collection("admins").doc(userEmail).get();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ac4de322._.js.map